    ...
    <div className="flex min-h-screen bg-[#F8F8FC] text-ink">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="h-16 border-b border-mist/40 bg-white/35 backdrop-blur-md px-6 flex items-center justify-between">
          ...
          <div className="h-8 w-8 rounded-full bg-mist/45 animate-pulse" />
        </header>

        {/* Dashboard Content Skeleton */}
        <main className="flex-grow p-6 md:p-8 space-y-8 max-w-7xl mx-auto w-full">
          {/* Welcome Header */}
          <div className="space-y-2">
            <div className="h-8 w-64 rounded-xl bg-mist/45 animate-pulse" />
            <div className="h-4 w-96 rounded-lg bg-mist/35 animate-pulse" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              <div className="h-80 rounded-2xl border border-white/60 bg-white/40 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.01)] animate-pulse" />
            </div>
